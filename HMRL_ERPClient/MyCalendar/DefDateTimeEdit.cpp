...
void DefDateTimeEdit::setMyStytle()
{
	...
	strTemp.append("QComboBox#CalComboBox{border:0px; background-color:rgb(0, 159, 149); \
                   ...
                   image:url(:/image/Calendar/ad.png);}\
    ...
    strTemp.append("QTimeEdit#CalTimeEdit:!enabled{ background:rgb(128, 79, 132); color:rgb(90, 90, 90); border:0px; }");
    ...
    strTemp.append("QTimeEdit#CalTimeEdit::up-button:!enabled{ background:rgb(128, 79, 132); }");
    strTemp.append("QTimeEdit#CalTimeEdit::up-arrow{  image:url(:/image/Calendar/au.png);}");
    ...
    strTemp.append("QTimeEdit#CalTimeEdit::down-button:!enabled{ background:rgb(128, 79, 132); }");
    strTemp.append("QTimeEdit#CalTimeEdit::down-arrow{  image:url(:/image/Calendar/ad.png);}");

	//QDateTimeEdit
	strTemp.append("QDateTimeEdit{border:1px solid gray; height:24px; }");
    strTemp.append("QDateTimeEdit::down-arrow{image:url(:/image/Calendar/calendar.png);}");
